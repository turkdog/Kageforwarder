...
namespace Client
{
    ...
    public class iTalk_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(15, 71, 0)), RoundRectangle.RoundRect(ClientRectangle, BorderCurve));
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(15, 71, 0)), RoundRectangle.RoundRect(new Rectangle(2, 2, (int)(Width / 2 + 2), 16), BorderCurve));
            G.FillPath(new SolidBrush(Color.FromArgb(15, 71, 0)), RoundRectangle.RoundRect(new Rectangle((int)(Width / 2 - 3), 2, (int)(Width / 2), 16), BorderCurve));
            // Fill the header rectangle below the patch
            G.FillRectangle(new SolidBrush(Color.FromArgb(15, 71, 0)), new Rectangle(2, 15, Width - 5, 10));

            // Increase the thickness of the container borders
            G.DrawPath(new Pen(Color.FromArgb(15, 71, 0)), RoundRectangle.RoundRect(new Rectangle(2, 2, Width - 5, Height - 5), BorderCurve));
            G.DrawPath(new Pen(Color.FromArgb(15, 71, 0)), RoundRectangle.RoundRect(ClientRectangle, BorderCurve));

            // Draw the string from the specified 'Text' property on the header rectangle
            G.DrawString(Text, new Font("Trebuchet MS", 10, FontStyle.Bold), new SolidBrush(Color.FromArgb(234, 255, 34)), new Rectangle(BorderCurve, BorderCurve - 4, Width - 1, 22), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Near });


            // Draws a rectangle at the bottom of the container
            G.FillRectangle(new SolidBrush(Color.FromArgb(15, 71, 0)), 0, Height - 25, Width - 3, 22 - 2);
            G.DrawLine(new Pen(Color.FromArgb(15, 71, 0)), 5, Height - 5, Width - 6, Height - 5);
            G.DrawLine(new Pen(Color.FromArgb(15, 71, 0)), 7, Height - 4, Width - 7, Height - 4);
    ...
    class iTalk_TextBox_Small : Control
    {
        ...
        public void AddTextBox()
        {
            ...
            _TB.Text = string.Empty;
            _TB.BackColor = Color.FromArgb(22, 31, 40);
            _TB.BorderStyle = BorderStyle.None;
            _TB.TextAlign = HorizontalAlignment.Left;
            _TB.Font = new Font("Tahoma", 11);
            _TB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public iTalk_TextBox_Small()
        {
            ...
            P1 = new Pen(Color.FromArgb(22, 31, 40)); // P1 = Border color
            B1 = new SolidBrush(Color.FromArgb(22, 31, 40)); // B1 = Rect Background color
            BackColor = Color.Transparent;
            ForeColor = Color.DimGray;
    ...
    public class iTalk_NumericUpDown : Control
    {
        ...
        public iTalk_NumericUpDown()
        {
            ...
            P1 = new Pen(Color.FromArgb(22, 31, 40)); // P1 = Border color
            B1 = new SolidBrush(Color.FromArgb(22, 31, 40)); // B1 = Rect Background color
            BackColor = Color.FromArgb(22, 31, 40);
            ForeColor = Color.DimGray;
    ...
    class iTalk_TabControl : TabControl
    {
        ...
        public iTalk_TabControl()
        {
            ...
            {
                Page.BackColor = Color.FromArgb(32, 41, 50);
            }
        }
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            if (e.Control is TabPage)
            {
                ...
                {
                    e.Control.BackColor = Color.FromArgb(32, 41, 50);
                }
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(Color.FromArgb(32, 41, 50)); //other big bg which was originally white
            ...
            _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(12, 21, 30)), new Rectangle(-5, 0, ItemSize.Height + 4, Height));//26, 38, 63 orig dark grey
            // Draw vertical line at the end of the tab selector rectangle
            _Graphics.DrawLine(new Pen(Color.FromArgb(44, 46, 51)), ItemSize.Height - 1, 0, ItemSize.Height - 1, Height);
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
            {
                if (TabIndex == SelectedIndex)
                {
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(17, 26, 35)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3); //orig almost black (selected tab color)
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(30, 144, 255)), TabHighlighter); //side of selected tab color
                    // Draw tab text
